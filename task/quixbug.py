...
class QuixbugDataset(CodeDataset):
    def __init__(self, 
                 repair_data_path,
                 local_cache_path,
                 quixbug_system_path, 
        ...
        self.clean_dataset = QuixbugDataset.parse_python(self.repair_data_path)
    ...
    def get_prompt(self, file_name):
        ...
        example_bug, example_fix = QuixbugDataset.pick_smallest_example_fix(self.clean_dataset, file_name)
